...
public class GetModelMetadataResponse   {
  ...
  public GetModelMetadataResponse creationDate(String creationDate) {
    this.creationDate = creationDate;
    return this;
  }

  /**
   * creation time of the model file
   * @return creationDate
   **/
  @Schema(description = "creation time of the model file")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.modelId, getModelMetadataResponse.modelId) &&
        ...
        Objects.equals(this.creationDate, getModelMetadataResponse.creationDate);
  }

  @Override
  public int hashCode() {
    return Objects.hash(modelId, fileName, modelType, creationDate);
  }
