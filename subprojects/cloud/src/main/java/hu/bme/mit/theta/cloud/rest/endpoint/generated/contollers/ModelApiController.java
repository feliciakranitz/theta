...
public class ModelApiController implements ModelApi {
    ...
    public ResponseEntity<List<StartProcessResponse>> startCfaAnalysis(@Parameter(in = ParameterIn.PATH, description = "The model id", required=true, schema=@Schema()) @PathVariable("modelId") UUID modelId,@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema())  @RequestBody StartCfaProcessRequest body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
    ...
    public ResponseEntity<List<StartProcessResponse>> startStsAnalysis(@Parameter(in = ParameterIn.PATH, description = "The model id", required=true, schema=@Schema()) @PathVariable("modelId") UUID modelId,@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema())  @RequestBody StartStsProcessRequest body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<StartProcessResponse>>(objectMapper.readValue("[ {\n  \"processId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"\n}, {\n  \"processId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<List<StartProcessResponse>> startXstsAnalysis(@Parameter(in = ParameterIn.PATH, description = "The model id", required=true, schema=@Schema()) @PathVariable("modelId") UUID modelId,@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema())  @RequestBody StartXstsProcessRequest body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<StartProcessResponse>>(objectMapper.readValue("[ {\n  \"processId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"\n}, {\n  \"processId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
    ...
    public ResponseEntity<List<StartProcessResponse>> startXtaAnalysis(@Parameter(in = ParameterIn.PATH, description = "The model id", required=true, schema=@Schema()) @PathVariable("modelId") UUID modelId,@Parameter(in = ParameterIn.DEFAULT, description = "", schema=@Schema())  @RequestBody StartXtaProcessRequest body) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
                return new ResponseEntity<List<StartProcessResponse>>(objectMapper.readValue("[ {\n  \"processId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"\n}, {\n  \"processId\" : \"046b6c7f-0b8a-43b9-b35d-6489e6daee91\"\n} ]", List.class), HttpStatus.NOT_IMPLEMENTED);
